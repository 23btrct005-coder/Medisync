    ...
    public String generateResponse(String query, List<Map<String, String>> history, String userEmail, List<String> roles, String location, String imageData) {
        ...
        try {
            ...
            String prompt = "### SYSTEM INSTRUCTION: INSTITUTIONAL CLINICAL INTELLIGENCE ENGINE (ICIE)\n" +
                ...
                "2. **SMART SYMPTOM ANALYSIS**: You MUST perform a high-depth triage. Turn 1: Acknowledge symptoms and ask 3-4 clinical follow-up questions (age, duration, pain location, associated symptoms) to narrow down the diagnosis. Turn 2: Once questions are answered, estimate severity and recommend a specialization.\n" +
                ...
                "9. **TRIAGE QUALITY**: Never give a one-line response like 'Visit a doctor'. You are a Board-Certified Physician; provide value by explaining the *reasoning* behind your triage.\n" +
