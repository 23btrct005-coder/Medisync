        ...
        try {
            ...
            if (response.getStatusCode().is2xxSuccessful() && response.getBody() != null && "success".equals(response.getBody().get("status"))) {
                ...
                return "Condition Summary:\n" +
                       "Based on your clinical signals, our Kaggle-trained Machine Learning model has analyzed your symptoms against 1,200 real patient records.\n\n" +
                       "Possible Diagnosis:\n" + diagnosis + " (Confidence: " + String.format("%.1f%%", confidence * 100) + ")\n\n" +
                       "Treatment Options:\n" + solution + "\n\n" +
