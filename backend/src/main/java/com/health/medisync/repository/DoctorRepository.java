...
public interface DoctorRepository extends JpaRepository<Doctor, Long> {
    ...
    java.util.List<Doctor> findByApprovedTrueAndNameContainingIgnoreCaseOrApprovedTrueAndSpecializationContainingIgnoreCase(String name, String specialization);
}
