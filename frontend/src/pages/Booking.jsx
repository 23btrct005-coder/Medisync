              ...
              <div className="glass-panel p-8 space-y-10">
                ...
                <section className="space-y-4">
                  ...
                  <input
                    ...
                    className={`w-full p-4 bg-slate-50 border-2 rounded-2xl outline-none font-bold text-slate-800 transition-all ${selectedDoctor.absenceDates && selectedDoctor.absenceDates.includes(bookingDate)
                      ...
                      <div className="relative p-12 bg-white/70 backdrop-blur-3xl rounded-[3.5rem] border border-white shadow-[0_32px_64px_-16px_rgba(225,29,72,0.1)] text-center space-y-8 transition-all duration-700 hover:shadow-[0_48px_80px_-16px_rgba(225,29,72,0.15)]">
                        ...
                        <div className="pt-4">
                          <button
                            ...
                            className={`group/btn w-full py-6 rounded-[2.5rem] font-black text-sm uppercase tracking-[0.2em] transition-all duration-700 relative overflow-hidden ${selectedSlot === 'IMMEDIATE'
                          ...
                          {availableSlots.map(slot => {
                            ...
                            return (
                              <button
                                ...
                                className={`px-4 py-4 rounded-2xl border-2 text-[10px] font-black uppercase tracking-widest transition-all ${selectedSlot === slot
              ...
              <div className="p-8 pt-4 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className={`w-full py-5 rounded-[2rem] text-sm font-black uppercase tracking-widest transition-all shadow-xl active:scale-95 ${(upiConfirmed && upiOrderData?.patientUpiId?.trim() && upiOrderData?.transactionId?.trim())
              ...
              <div className="grid grid-cols-4 gap-3 mb-8">
                {BLOOD_GROUPS.map(bg => (
                  <button
                    ...
                    className={`py-4 rounded-2xl font-black text-sm border-2 transition-all active:scale-95 ${selectedBloodGroup === bg
