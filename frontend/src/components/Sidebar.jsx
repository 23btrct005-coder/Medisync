          ...
          {isHospital ? (
            ...
            <>
              ...
              >
                ...
                <div className="ml-auto bg-primary-100 text-primary-700 text-[10px] px-1.5 py-0.5 rounded-full font-black uppercase tracking-tighter">AI</div>
              </button>
