...
const ClinicalChatBox = ({ receiverId, receiverName, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 w-full h-[100dvh] md:bottom-6 md:right-6 md:w-96 md:h-[600px] bg-white md:rounded-[2.5rem] shadow-[0_0_100px_rgba(0,0,0,0.3)] md:border border-slate-200/60 flex flex-col overflow-hidden z-[10000] animate-in slide-in-from-bottom-full md:slide-in-from-bottom-8 duration-500 text-left">
